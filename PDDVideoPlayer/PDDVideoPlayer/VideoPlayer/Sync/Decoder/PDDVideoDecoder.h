...
@property (readwrite, nonatomic) PDDFrameType type;
...
@property (readwrite, nonatomic) NSUInteger linesize; // 这个是啥
...
@property (readwrite, nonatomic, strong) id imageBuffer; // 这个是啥
...
- (BOOL)openFile:(NSString *)path parameter:(NSDictionary *)parameters error:(NSError **)error;
